const en = {
  ...
  about: {
    ...
    quote: `Quote`,
    quoteDesc: `A senior frontend developer should always clearly issue and find the best solution for different situation. Has high communication skill with backend , UIUX and PM.`,
    duty: `Duty`,
    special: `Special`,
    speaker: `speaker`,
